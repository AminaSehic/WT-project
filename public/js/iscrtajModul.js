let Raspored = (function () {
    ...
    let generisiSate = function (div, satPocetak, satKraj) {
        ...
        for (let i = 0; i < brojCelija; i++) {
            ...
            //u svaku cetvrtu celiju se treba upisati sat
    ...
    let generisiRedove = function (div, dani, satPocetak, satKraj) {
        for (let i = 0; i < dani.length; i++) {
    ...
    let daLiJeIspravnoVrijeme = function (vrijeme) {
        vrijeme *= 10;
        return (vrijeme % 10 === 5 || vrijeme % 10 === 0);
    }

    let redZaDan = function (raspored, dan) {
    ...
    let dajPocetakIKrajRasporeda = function (raspored) {
    ...
    return {
        ...
        dajPocetakIKrajRasporeda: dajPocetakIKrajRasporeda
    }
}());
